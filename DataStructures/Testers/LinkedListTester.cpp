...
//  DataStructures
//
//  Created by Montoya, Aaron on 2/20/18.
...
void LinkedListTester :: testListBasics()
{
    ...
    cout << numbers.getFront()->getData() << " Is at the front of the list and should be 3212" << endl;
    cout << numbers.getEnd()->getData() << " Is at the list and should be 32567" << endl;
}
...
void LinkedListTester :: testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readDataToList("/Users/amon1978/C Plus Plus/DataStructures/DataStructures/Data/crime.csv");
    listTimer.stopTimer();
